...
public class EmployeeController {
	 ...
	 * 
	 * @author kpn
	 * @apiNote csv upload web service
	 * 
	 **/
	@PostMapping("/upload")
	public ResponseEntity<?> uploadFile(@RequestParam("file") MultipartFile file) {
		...
		return ResponseEntity.status(HttpStatus.BAD_REQUEST)
				.body(new ResponseMessage(message, "check your file detail or format"));
	}

	/**
	 * 
	 * @author kpn
	 * @apiNote filtered employees web service for front end datatables
	 * 
	 **/
	@RequestMapping(method = RequestMethod.GET, path = "/users")
	public synchronized ResponseEntity<?> filteredEmployees(
			@RequestParam(name = "minSalary") Optional<Double> minSalary,
			@RequestParam(name = "maxSalary") Optional<Double> maxSalary,
			@RequestParam(name = "offset") Optional<Integer> offset,
			@RequestParam(name = "limit") Optional<Integer> limit, @RequestParam(name = "sort") String sort) {
	 ...
	 * 
	 * @author kpn
	 * @apiNote retrieving employee web service by id
	 * 
	 **/
	 ...
	 * 
	 * @author kpn
	 * @apiNote creating employee web service
	 * 
	 **/
	...
	public synchronized ResponseEntity<?> createEmployee(@RequestBody String employeeJsonString) {
		try {
			...
			Employee employee = new Employee(employeeJson.getString("id"), employeeJson.getString("login"),
					employeeJson.getString("name"), Double.parseDouble(employeeJson.getString("salary")));

			return new ResponseEntity<>(employeeService.saveEmployee(employee) != null ? employeeJsonString : null,
					HttpStatus.OK);
		} catch (Exception e) {
	 ...
	 * 
	 * @author kpn
	 * @apiNote updating employee web service
	 * 
	 **/
	...
	public synchronized ResponseEntity<?> updateEmployee(@RequestBody String employeeJsonString) {
		try {
			...
			return new ResponseEntity<>(
					employeeService.checkAndUpdateEmployee(employee) != null ? employeeJsonString : null,
					HttpStatus.OK);
		} catch (Exception e) {
			return new ResponseEntity<>(null, HttpStatus.BAD_REQUEST);
		}
	 ...
	 * 
	 * @author kpn
	 * @apiNote deleting employee web service
	 * 
	 **/
